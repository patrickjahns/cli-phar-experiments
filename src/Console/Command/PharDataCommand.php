...
class PharDataCommand extends Command
{
	...
	protected function execute(InputInterface $input, OutputInterface $output)
	{
		...
		$finder = new Finder();
		$finder->in($srcDirectory)->ignoreVCS(true)->ignoreDotFiles(true)->files()->followLinks();
		$archive = new \PharData($targetFile);
		$archive->buildFromIterator($finder, './tests/data');
